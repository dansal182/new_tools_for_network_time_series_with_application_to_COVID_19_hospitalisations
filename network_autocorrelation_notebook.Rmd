...
```{r, fig.width=14,fig.height=10, echo=TRUE}
  print(corbit_plot(vts = gdpVTS, net = igraphtoGNAR(net_result), max_lag = 10, max_stage = max_stage_nacf, weight_matrix = W0, line_segment = "yes"))
```

We can produce a rectangular Corbit plot by setting $\texttt{rectangular_plot = "yes"}$. 

```{r, fig.width=14,fig.height=10, echo=TRUE}
  print(corbit_plot(vts = gdpVTS, net = igraphtoGNAR(net_result), max_lag = 10, max_stage = max_stage_nacf, weight_matrix = W0, rectangular_plot="yes"))
```

Finally, setting $\texttt{rectangular_plot = "square"}$ produces a square Corbit plot.

```{r, fig.width=14,fig.height=10, echo=TRUE}
  print(corbit_plot(vts = gdpVTS, net = igraphtoGNAR(net_result), max_lag = 10, max_stage = max_stage_nacf, weight_matrix = W0, rectangular_plot="square"))
```
